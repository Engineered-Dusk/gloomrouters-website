(() => {
  ...
  const CARDS = {
    ...
    signal_purge: { name: 'Signal Purge', type: 'route', rarity: 'neutral', cost: 0, routeCores: 4, routeDraw: 2, routeMagnitude: 1, rulesText: "Route: Choose and discard an opponent's Module from play. Then draw a Module from your deck, if able." },
    ...
    relay_collapse: { name: 'Relay Collapse', type: 'route', rarity: 'neutral', cost: 0, routeCores: 3, routeDraw: 2, routeMagnitude: 1, rulesText: 'Route: Each player chooses 1 Node they control and discards each other Node.' },
